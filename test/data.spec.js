import { moviesList, dataSortedOld, dataSortedNew, dataSortedAZ, dataSortedZA} from '../src/data.js';
const entry = [{"id": "2baf70d1-42bb-4437-b551-e5fed5a87abe",
    ...
    "producer": "Hayao Miyazaki", "release_date": "1988"},
    ...
    "producer": "Toshio Suzuki", "release_date": "1995"},
    {"id": "90b72513-afd4-4570-84de-a56c312fdf81",
    "title": "The Cat Returns","director": "Hiroyuki Morita",
    "producer": "Toshio Suzuki", "release_date": "2002"}];

const entry2 = [{"title": "Spirited Away", "release_date": "2001"}, 
...
describe('dataSortedOld', () => {
  ...
  const output1 = [{"title": "Whisper of the Heart", "release_date": "1995"}, {"title": "Princess Mononoke", "release_date": "1997"},{"title": "My Neighbors the Yamadas", "release_date": "1999"}, {"title": "Spirited Away", "release_date": "2001"}, {"title": "Howl's Moving Castle", "release_date": "2004"}]
  it('returns output1', () => {
...
describe('dataSortedOld', () => {
  ...
  const output2 = [{"title": "Howl's Moving Castle", "release_date": "2004"}, {"title": "Spirited Away", "release_date": "2001"}, {"title": "My Neighbors the Yamadas", "release_date": "1999"}, {"title": "Princess Mononoke", "release_date": "1997"}, {"title": "Whisper of the Heart", "release_date": "1995"}]
  it('returns output2', () => {
...
describe('dataSortedAZ', () => {
  ...
  const output1 = [{"title": "Howl's Moving Castle", "release_date": "2004"},  {"title": "My Neighbors the Yamadas", "release_date": "1999"}, {"title": "Princess Mononoke", "release_date": "1997"}, {"title": "Spirited Away", "release_date": "2001"}, {"title": "Whisper of the Heart", "release_date": "1995"}]
  it('returns output1', () => {
...
describe('dataSortedZA', () => {
  ...
  const output2 = [{"title": "Whisper of the Heart", "release_date": "1995"}, {"title": "Spirited Away", "release_date": "2001"}, {"title": "Princess Mononoke", "release_date": "1997"}, {"title": "My Neighbors the Yamadas", "release_date": "1999"},{"title": "Howl's Moving Castle", "release_date": "2004"}]
  it('returns output1', () => {
